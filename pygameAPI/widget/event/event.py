...
class Events:
    def __init__(self):
        ...
        self._dict_window_events = {
            pygame.VIDEORESIZE : self.window_resize
        }
    ...
    def process_events(self, events):
        ...
        for event in events:
            ...
            elif event.type in self._dict_window_events:
                event = self._window_event(event)
            else:
    ...
    def _window_event(self, event):
        return self._dict_window_events[event.type](event)
